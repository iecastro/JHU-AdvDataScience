...
The [storm event database](https://www1.ncdc.noaa.gov/pub/data/swdi/stormevents/csvfiles/) goes back until 1950, with one file per year. You will likely not need all of it.
